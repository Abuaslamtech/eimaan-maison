  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-6 text-center">
        <p className="font-body text-[0.65rem] tracking-[0.3em] uppercase text-[#d4a843] mb-6">
          Ready to Begin?
        </p>
        ...
        <p className="font-body text-sm text-[#fdf8ef]/55 mb-12 max-w-md mx-auto">
        ...
        <div className="flex items-center justify-center gap-8">
          <a
            href="https://instagram.com/eimaanmaison"
            target="_blank"
            rel="noopener noreferrer"
            id="footer-instagram"
            className="flex items-center gap-2 font-body text-[0.7rem] tracking-widest uppercase text-[#fdf8ef]/40 hover:text-[#d4a843] transition-colors"
          >
            <Globe size={16} />
            Instagram
          </a>
          <span className="text-[#d4a843]/20">·</span>
          <a
